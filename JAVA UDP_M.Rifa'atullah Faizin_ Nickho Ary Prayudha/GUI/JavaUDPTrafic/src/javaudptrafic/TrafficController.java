...
public class TrafficController extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TrafficController
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            int port =1997;
            InetAddress ip = InetAddress.getByName("192.168.43.127");
            lampu = "merah";
            byte[] data = lampu.getBytes();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            int port =1997;
            InetAddress ia = InetAddress.getByName("192.168.43.127");
            lampu = "kuning";
            byte[] b = lampu.getBytes();
